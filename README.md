...
This project is a **Product Management Dashboard** built using **Next.js** that allows multiple admins to manage products and monitor inventory. The application includes **admin authentication**, **role-based access**, and **real-time data storage using MongoDB Atlas**.
